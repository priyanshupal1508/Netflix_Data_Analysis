...
This project is a simple and beginner-friendly Python analysis of a Netflix movie dataset.
The goal is to explore the dataset, clean it, and find interesting insights about movie genres, popularity, votes, and yearly release trends.
The project shows how to use Python, Pandas, and basic data analysis techniques in a practical way.
